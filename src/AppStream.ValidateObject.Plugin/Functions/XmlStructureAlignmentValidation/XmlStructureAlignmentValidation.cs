...
public class XmlStructureAlignmentValidation
{
    ...
    [OpenApiParameter(name: "xml1", Description = "First escaped XML object that is a sample XML to verify against", Type = typeof(string), In = ParameterLocation.Query, Required = true)]
    [OpenApiParameter(name: "xml2", Description = "Second escaped XML object to verify", Type = typeof(string), In = ParameterLocation.Query, Required = true)]
